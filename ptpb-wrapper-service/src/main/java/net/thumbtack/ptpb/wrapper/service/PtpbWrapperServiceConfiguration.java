...
import net.thumbtack.ptpb.wrapper.db.project.ProjectDaoImpl;
...
//    @Bean
//    public SynchronizationService getSynchronizationService(ObjectMapper mapper, UserDao userDao,
...
//        SynchronizationService service = new SynchronizationService(mapper, userDao, projectDao(projectMapper), itemDao, syncDao, todoistClientService);
//        rabbitMqMessageProvider.registerHandler(SyncUserAmqpRequest.class.getSimpleName(), service::syncUser);
//        return service;
//    }

//    @Bean
//    public ProjectDao projectDao(ProjectMapper projectMapper) {
//        return new ProjectDaoImpl(projectMapper);
//    }
