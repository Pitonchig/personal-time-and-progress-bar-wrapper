...
import net.thumbtack.ptpb.wrapper.service.synchronization.responses.GetItemAmqpResponse;
import net.thumbtack.ptpb.wrapper.service.synchronization.responses.GetProjectAmqpResponse;
...
import static net.thumbtack.ptpb.wrapper.service.synchronization.ErrorCode.*;
...
public class SynchronizationService {
    ...
    private GetItemAmqpResponse itemToGetItemAmqpResponse(Item item) {
        GetItemAmqpResponse amqpResponse = GetItemAmqpResponse.builder()
                .id(item.getId())
